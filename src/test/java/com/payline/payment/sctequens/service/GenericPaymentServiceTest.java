package com.payline.payment.sctequens.service;

import com.payline.payment.sctequens.MockUtils;
import com.payline.payment.sctequens.bean.GenericPaymentRequest;
import com.payline.payment.sctequens.bean.business.payment.Address;
import com.payline.payment.sctequens.bean.business.payment.PaymentData;
import com.payline.payment.sctequens.bean.business.payment.PaymentInitiationRequest;
...
class GenericPaymentServiceTest {
    ...
    void buildPaymentInitiationRequest() {
        ...
        Assertions.assertEquals(paymentInitiationRequest.getPsuId(), genericPaymentRequest.getBuyer().getCustomerIdentifier());
