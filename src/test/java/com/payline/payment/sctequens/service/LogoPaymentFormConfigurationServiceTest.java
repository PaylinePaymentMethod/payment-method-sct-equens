...
public class LogoPaymentFormConfigurationServiceTest {
    ...
    void getWalletLogoNominal(){
        ...
        PaymentFormLogo paymentFormLogo = testService.getWalletLogo("SCT_EQUENS", Locale.getDefault());
    ...
    void getWalletLogoWithWrongConfiguration(){
        ...
        // check
        assertThrows(PluginException.class, () -> testService.getWalletLogo("SCT_EQUENS",
                Locale.getDefault()));
    }
